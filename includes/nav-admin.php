...
<aside class="sidebar">
    <div class="sidebar-header">
        <a href="/admin/dashboard.php" class="sidebar-logo">
            ...
            <span class="sidebar-logo-text">ALMS Admin</span>
        </a>
    ...
    <nav class="sidebar-nav">
        <div class="sidebar-section-label">Management Desk</div>
        ...
        <a href="/admin/departments.php" class="sidebar-link <?= $currentPage === 'departments' ? 'active' : '' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="/admin/courses.php" class="sidebar-link <?= $currentPage === 'courses' ? 'active' : '' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="/admin/lecturers.php" class="sidebar-link <?= $currentPage === 'lecturers' ? 'active' : '' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="sidebar-section-label">Audit & Config</div>

        <a href="/admin/logs.php" class="sidebar-link <?= $currentPage === 'logs' ? 'active' : '' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            ...
            <div class="sidebar-user-info">
                ...
                <div class="sidebar-user-id font-mono-data">SYSADMIN</div>
            </div>
        </div>
    </div>
</aside>
